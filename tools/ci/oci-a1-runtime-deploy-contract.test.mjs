...
test("GitHub Actions deploy workflow builds jar, bundles it, and deploys on the server runner", () => {
  ...
  for (const secret of [
    ...
    "APP_AUTH_OIDC_ENABLED_PROVIDERS",
    "APP_AUTH_OIDC_CLIENT_ID",
    "APP_AUTH_OIDC_PROVIDER_AUTHORIZATION_BASE_URL",
    "APP_AUTH_OIDC_PROVIDER_TOKEN_BASE_URL",
    "APP_AUTH_OIDC_PROVIDER_JWKS_BASE_URL",
    "APP_AUTH_OIDC_PROVIDER_ISSUER_BASE_URL",
    "APP_AUTH_OIDC_DEFAULT_APP_REDIRECT_URI",
    "APP_AUTH_OIDC_NAVER_AUTHORIZATION_URI",
    "APP_AUTH_OIDC_NAVER_CLIENT_ID",
    "APP_AUTH_OIDC_NAVER_CLIENT_SECRET",
    "APP_AUTH_OIDC_NAVER_SCOPE",
    "APP_AUTH_OIDC_NAVER_TOKEN_URI",
    "APP_AUTH_OIDC_NAVER_JWKS_URI",
    "APP_AUTH_OIDC_NAVER_ISSUER",
    "APP_AUTH_OIDC_KAKAO_AUTHORIZATION_URI",
    "APP_AUTH_OIDC_KAKAO_CLIENT_ID",
    "APP_AUTH_OIDC_KAKAO_CLIENT_SECRET",
    "APP_AUTH_OIDC_KAKAO_SCOPE",
    "APP_AUTH_OIDC_KAKAO_TOKEN_URI",
    "APP_AUTH_OIDC_KAKAO_JWKS_URI",
    "APP_AUTH_OIDC_KAKAO_ISSUER",
    "APP_AUTH_OIDC_FACEBOOK_AUTHORIZATION_URI",
    "APP_AUTH_OIDC_FACEBOOK_CLIENT_ID",
    "APP_AUTH_OIDC_FACEBOOK_CLIENT_SECRET",
    "APP_AUTH_OIDC_FACEBOOK_SCOPE",
    "APP_AUTH_OIDC_FACEBOOK_TOKEN_URI",
    "APP_AUTH_OIDC_FACEBOOK_JWKS_URI",
    "APP_AUTH_OIDC_FACEBOOK_ISSUER",
    "APP_AUTH_OIDC_GOOGLE_AUTHORIZATION_URI",
    "APP_AUTH_OIDC_GOOGLE_CLIENT_ID",
    "APP_AUTH_OIDC_GOOGLE_CLIENT_SECRET",
    "APP_AUTH_OIDC_GOOGLE_SCOPE",
    "APP_AUTH_OIDC_GOOGLE_TOKEN_URI",
    "APP_AUTH_OIDC_GOOGLE_JWKS_URI",
    "APP_AUTH_OIDC_GOOGLE_ISSUER",
    "APP_AUTH_OIDC_APPLE_AUTHORIZATION_URI",
    "APP_AUTH_OIDC_APPLE_CLIENT_ID",
    "APP_AUTH_OIDC_APPLE_CLIENT_SECRET",
    "APP_AUTH_OIDC_APPLE_SCOPE",
    "APP_AUTH_OIDC_APPLE_TOKEN_URI",
    "APP_AUTH_OIDC_APPLE_JWKS_URI",
    "APP_AUTH_OIDC_APPLE_ISSUER",
  ]) {
