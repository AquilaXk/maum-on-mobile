...
test("path classifier enables all mobile release checks for performance contracts", async () => {
  const outputs = await classifyChangedFiles(["contracts/performance/release-performance-gate.json"]);
